...
export default function LoginPage() {
    ...
    const handleLogin = async () => {
        setIsLoading(true);
        // Middleware handles the destination after login (usually /)
        // or we can force it to / which then logic takes over
            ...
            <div className="w-full max-w-md p-8 relative z-10">
                <div className="gta-card bg-black/60 backdrop-blur-xl border-zinc-800 p-10 flex flex-col items-center text-center shadow-2xl shadow-primary/10">
                    ...
                    <button
                        onClick={handleLogin}
                        disabled={isLoading}
                        className="w-full gta-btn h-14 text-base font-bold shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:scale-[1.02] transition-all disabled:opacity-50 disabled:pointer-events-none"
                    >
